...
{   //loading up the document
     ...
     */
    queue.loadManifest([
        {id: 'backgroundImage', src: 'assets/galacticCanvas.png'},
        {id: 'crossHair', src: 'assets/crosshair.png'},
        {id: 'shot', src: 'assets/laser.ogg'},
        {id: 'background', src: 'assets/Rainbows_and_Sunshine!!!.mp3'},
        {id: 'gameOverSound', src: 'assets/lachanceInsurance.mp3'},

        {id: 'deathSound', src: 'assets/die.mp3'},
        {id: 'redSpritesheet', src: 'assets/redSpritesheet.png'},
        // substituted batDeath with fishDeath-----------------------------
        {id: 'fishDeath', src: 'assets/fishDeath.png'},
...
function queueLoaded(event)
{
    ...
    spriteSheet = new createjs.SpriteSheet({
        "images": [queue.getResult('redSpritesheet')],
        "frames": {"width": 150, "height": 117},
        "animations": { "flap": [0,5] }
    });

    // Create bat death spritesheet
    batDeathSpriteSheet = new createjs.SpriteSheet({
      // used fishDeath as substitue------------------------------------------
    	// "images": [queue.getResult('batDeath')],
      "images": [queue.getResult('fishDeath')],
